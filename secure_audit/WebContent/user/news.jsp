...
<html>
<head>
<title>Media-Center for Website Template | Home :: w3layouts</title>
...
<div class="header">
	   ...
	   <div class="menu">
			<ul>
				...
				<li><a href="news.jsp">Services</a></li>
...
<div class="blog-right">
         ...
         <div class="services-top">
            	...
            	<h3>Lorem wisi enim ad minim veniam ullamcorper suscipit lobortis nisl </h3>
            	</div>
		          <div class="image">
	 ...
	 <div class="services-top">	 
		   	<div class="sub-service">
            	<h3>Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl </h3>
           	</div>
          <div class="image">
	...
	<div class="wrap">
	  <div class="footer-nav">
				<div class="footer-image">
					<a href=""><img src="images/visit1.png"></a>
				</div>
				<div class="footer-desc">
					<h5>Visit</h5>
					<a href=""><p>info@site.com</p></a>
				</div>
					<div class="clear"></div>
		</div>
		<div class="footer-nav">
