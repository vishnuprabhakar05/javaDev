...
<div class="wrapper">
 	...
 	<div class="preview preview1">
		...
		<a href="sign_in.jsp"><img src="images/log.jpg"></a><span>Username</span>
...
<div class="blog">
		...
		<div class="chat">
		<div class="clos">
		<a href=""><img src="images/clos.png"></a>
		</div>
			<div class="chat1">
				<div class="form">
					<form class="cmxform" id="contactForm" method="post" >
                    <div class="to1 to3">
					<img src="images/sent11600.png" >
					<img src="images/camera-icon-21.png" style="right: 27px;">
					 <input type="text" class="text" value="Type your message" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Type your message';}" style="width: 200px;margin: 0;">
